	...
	Config.NetServices = []ConfigNetServices{}
        ...
        for _, section := range cfg.Sections() {
                ...
                if strings.Index(section.Name(), "ircservices") == 0 {
                        ...
                        ircservices.Xmlrpc_URL = section.Key("xmlrpc_url").MustString("http://127.0.0.1:8080/xmlrpc")
                        ...
                        ircservices.IRCservices_URI = section.Key("ircservices_uri").MustString("/webirc/ircservices/")
