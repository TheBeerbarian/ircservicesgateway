...
func loadPage(w http.ResponseWriter, r *http.Request) {
	...
	fmt.Fprintln(w, "      <th colspan=\"3\" style=\"margin: 0 auto;padding: 0;text-align: left;\">")
	fmt.Fprintln(w, "        Test to check command to a Network Service.")
	fmt.Fprintln(w, "      </th>")
	fmt.Fprintln(w, "      <tr>")
	fmt.Fprintln(w, "        <td>")
	...
	fmt.Fprintln(w, "      <th colspan=\"3\" style=\"margin: 0 auto;padding: 0;text-align: left;\">")
	fmt.Fprintln(w, "        Test to check status of Network Services.")
	fmt.Fprintln(w, "      </th>")
	fmt.Fprintln(w, "      <tr>")
	fmt.Fprintln(w, "        <td>")
	fmt.Fprintln(w, "          <input type=\"radio\" name=\"method\" value=\"stats\">")
	fmt.Fprintln(w, "        </td><td>")
	fmt.Fprintln(w, "          <-- Select for Status.")
	fmt.Fprintln(w, "        </td><td>")
	fmt.Fprintln(w, "        </td>")
	fmt.Fprintln(w, "      </tr>")

	fmt.Fprintln(w, "      <th colspan=\"3\" style=\"margin: 0 auto;padding: 0;text-align: left;\">")
	fmt.Fprintln(w, "         Test to request #channel information.")
	fmt.Fprintln(w, "      </th>")
	fmt.Fprintln(w, "      <tr>")
	fmt.Fprintln(w, "        <td>")
	...
	fmt.Fprintln(w, "      <th colspan=\"3\" style=\"margin: 0 auto;padding: 0;text-align: left;\">")
	fmt.Fprintln(w, "        Test to request user information.")
	fmt.Fprintln(w, "      </th>")
	fmt.Fprintln(w, "      <tr>")
	fmt.Fprintln(w, "        <td>")
	fmt.Fprintln(w, "          <input type=\"radio\" name=\"method\" value=\"user\"> ")
	fmt.Fprintln(w, "        </td><td>")
	fmt.Fprintln(w, "          <input type=\"text\" placeholder=\"#user\" name=\"user\">&nbsp;&nbsp;")
	fmt.Fprintln(w, "        </td><td>")
	fmt.Fprintln(w, "        </td>")
	fmt.Fprintln(w, "      </tr>")
